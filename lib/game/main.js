...
(function() {
  ...
  elems.gui.paused.add(elems.gui.gameName).each(function() {
    return $(this).css({
      top: (elems.canvas.height() - $(this).height()) / 2,
      left: (elems.canvas.width() - $(this).width()) / 2
    });
  });
  ...
  ig.module('game.main').requires('impact.game', 'impact.font', 'impact.debug.debug', 'plugins.impact-splash-loader', 'plugins.director.director', 'game.levels.market1', 'game.levels.forest1', 'game.entities.common.base-entity', 'game.entities.common.particle-generator', 'game.entities.common.particle', 'game.entities.weapons.axe', 'game.entities.weapons.fireball', 'game.entities.inventory', 'game.entities.inventory-item', 'game.entities.player', 'game.entities.trader', 'game.entities.stall', 'game.entities.tree', 'game.entities.log', 'game.entities.menu', 'game.entities.enemy').defines(function() {
    ...
    MainGame = ig.Game.extend({
      ...
      draw: function() {
        var hudString;
        this.parent();
        hudString = "Weapon: " + this.player.activeWeapon + "\nHealth: " + this.player.health + "\nMana: " + this.player.mana + "\nLogs: " + (this.player.inventory.getCount('log'));
        return this.info.draw(hudString, 20, 20);
      },
      pause: function() {
        var _ref;
    ...
    StartScreen = ig.Game.extend({
      ...
      draw: function() {
        ...
        this.parent();
        x = ig.system.width / 2;
        y = ig.system.height - this.instructFont.heightForString(this.instructText) - 10;
        this.instructFont.draw(this.instructText, x, y, ig.Font.ALIGN.CENTER);
        return elems.gui.gameName.show();
      }
    });
