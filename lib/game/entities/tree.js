    ...
    return EntityTree = EntityStaticEntity.extend({
      ...
      receiveDamage: function(amount, from) {
        ...
        switch (ig.game.player.facing) {
          case 'Up':
            x = player.pos.x;
            y = player.pos.y - this.particleOffset;
            break;
          case 'Down':
            x = player.pos.x;
            y = player.pos.y + player.size.y + this.particleOffset;
            break;
          case 'Right':
            x = player.pos.x + player.size.x + this.particleOffset;
            y = player.pos.y;
            break;
          case 'Left':
            x = player.pos.x - this.particleOffset;
            y = player.pos.y;
        }
