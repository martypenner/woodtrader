  ...
  ig.module('game.entities.player').requires('game.entities.common.base-entity', 'game.entities.inventory', 'game.entities.weapons.axe', 'game.entities.weapons.fireball').defines(function() {
    return EntityPlayer = EntityBaseEntity.extend({
      ...
      handleButtons: function() {
        ...
        */
        ...
        if (ig.input.pressed('attack')) {
          this.currentAnim = this.anims[this.weapon + this.facing];
          this.weaponAnimTimer = new ig.Timer();
          weapon = ig.game.spawnEntity('Entity' + this.weapon.substring(0, 1).toUpperCase() + this.weapon.substring(1), 0, 0, {
            facing: this.facing
          });
      ...
      switchWeapon: function() {
        var weapon;
        weapon = this.weapons.indexOf(this.weapon) + 1;
        if (weapon > this.weapons.length - 1) {
          weapon = 0;
        }
        return this.weapon = this.weapons[weapon];
      },
      reset: function() {
