(function() {
  ...
  */;
  ...
  ig.module('game.entities.player').requires('game.entities.common.base-entity', 'game.entities.inventory', 'game.common.weapon-manager', 'game.entities.weapons.axe', 'game.entities.weapons.fireball').defines(function() {
