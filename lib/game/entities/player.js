  ...
  ig.module('game.entities.player').requires('game.entities.common.base-entity', 'game.entities.inventory', 'game.entities.weapons.axe').defines(function() {
    return EntityPlayer = EntityBaseEntity.extend({
      ...
      init: function(x, y, settings) {
        ...
        this.addAnim('idleUp', this.idleAnimSpeed, [10]);
        this.addAnim('idleRight', this.idleAnimSpeed, [20]);
        this.addAnim('idleLeft', this.idleAnimSpeed, [30]);
        this.addAnim('walkDown', this.movingAnimSpeed, [0, 1, 0, 2]);
        this.addAnim('walkUp', this.movingAnimSpeed, [10, 11, 10, 12]);
        this.addAnim('walkRight', this.movingAnimSpeed, [20, 21, 20, 22]);
        this.addAnim('walkLeft', this.movingAnimSpeed, [30, 31, 30, 32]);
