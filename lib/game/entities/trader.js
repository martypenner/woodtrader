      ...
      draw: function() {
        ...
        if (this.playerIsNear) {
          if (this.dialogVisible) {
            this.dialogs[0].draw(this.pos.x - ig.game.screen.x - 2, this.pos.y - ig.game.screen.y - 80);
          } else {
            this.bubble.draw(this.pos.x - ig.game.screen.x - 2, this.pos.y - ig.game.screen.y - 43);
          }
        }
        return this.parent();
      }
