//@ sourceMappingURL=particle-generator.map
/*;
...
ig.module('game.entities.common.particle-generator').requires('game.entities.common.particle', 'plusplus.core.entity').defines(function() {
  return EntityParticleGenerator = ig.EntityExtended.extend({
    lifetime: 1,
    callback: null,
    particles: 25,
    idleTimer: null,
