...
ig.module('game.entities.common.trigger').requires('plusplus.core.entity').defines(function() {
  return EntityTrigger = ig.EntityExtended.extend({
    size: {
      x: 16,
      y: 16
    },
