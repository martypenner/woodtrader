...
(function() {
  ...
  */;
  ...
  ig.module('game.common.weapon-manager').requires('game.entities.common.static-entity').defines(function() {
    return WeaponManager = ig.Class.extend({
      ...
      changeEntityAnimation: function(entity) {
        ...
        return entity.currentAnim = entity.anims[entity.activeWeapon + entity.facing];
      },
      spawnWeapon: function(entity) {
        ...
        manaAfterCast = (entity.mana != null) && (entity[entity.activeWeapon + 'ManaCost'] != null) ? entity.mana - entity[entity.activeWeapon + 'ManaCost'] : -1;
        if ((entity.activeWeapon === 'fireball' && manaAfterCast >= 0) || entity.activeWeapon === 'axe') {
          if (entity.activeWeapon === 'fireball') {
            entity.mana -= entity[entity.activeWeapon + 'ManaCost'];
            entity.manaRegenerateDelayTimer = new ig.Timer();
          }
          weaponEntity = ig.game.spawnEntity('Entity' + entity.activeWeapon.substring(0, 1).toUpperCase() + entity.activeWeapon.substring(1), 0, 0, {
            facing: entity.facing
          });
          return weaponEntity.pos = this.getWeaponCoordinates(weaponEntity, entity);
        }
      }
    });
  });
